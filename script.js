...
아멘.`
  ...
  // ✅ 소식 내용
  newsIntro: "이번 주 공지/안내 사항입니다.",
  newsItems: [
    {
      title: "✅ 수련회 준비 기도회 안내",
      body:
        "1.31(토) 오전 10시 30분에 수련회 준비를 위한 마지막 준비 기도회가 있습니다.\n" +
        "교회 또는 각자의 자리에서 자유롭게 참여해주세요.",
    },
    {
      title: "✅ 2026 청년부 동계수련회 공지",
      body:
        "주제: 온전하게 하시는 예수를 보라(히 11:1~2 / 12:1~2)\n" +
        "일시: 2.6(금) ~ 2.7(토)\n" +
        "장소: 해안남로 1588-15 모담스테이(강화도)\n" +
        "교회 집합 시간: 2.6(금) 오후 12시(청년부 예배실로 모이세요)\n" +
        "회비: 15,000원 / 진선민 청년에게 제출(카카오페이 가능합니다)\n" +
        "문의: 심광일 목사님, 배태욱 청년\n" +
        "🔥주요 프로그램: 찬양과 예배, 눈썰매, 건식사우나, 고기파티, 불멍, 닌텐도스위치 등",
    },
  ],
